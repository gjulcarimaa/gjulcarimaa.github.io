...
<li> [*Democracy as neoliberalism’s caboose*](https://www.pressenza.com/2023/01/democracy-as-neoliberalisms-caboose/), **Pressenza - International Press Agency Instituto de Estudios Políticos Andinos**, January 8, 2023. \medskip </li>

```{r}
knitr::include_url("https://www.pressenza.com/2023/01/democracy-as-neoliberalisms-caboose/")
```

```{r, out.width=720, out.extra='style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay"'}
knitr::include_url("https://www.pressenza.com/2023/01/democracy-as-neoliberalisms-caboose/", height = 405)
```
